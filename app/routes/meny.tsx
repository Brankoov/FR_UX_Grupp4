  ...
  return (
    <div>
      ...
      <section style={{ textAlign: "center", margin: "40px 0" }}>
        <h1>Catering meny</h1>
        <p>
          Våra bufféer går att anpassa efter era preferenser, skicka en
          förfrågan!
        </p>
      </section>
      ...
      >
        {buffetList.map((buffet) => (
          ...
          >
            <img
              src={buffet.image}
              alt={`Bild på ${buffet.name}`}
              style={{ width: "100%", height: "200px", objectFit: "cover" }}
              loading="lazy"
            />
            <h2>{buffet.name}</h2>
            <p>
              <strong>Fr. {buffet.price} kr / pp</strong>
            </p>
            {buffet.categories.map(
              (
                category: {
                  title:
                    | string
      ...
      <section style={{ textAlign: "center", margin: "40px 0" }}>
        ...
        <p>
          Ta en titt på vårat exklusiva utbud och få den perfekta
          lunchupplevelse
        </p>
      </section>
